...
The scenarios are designed to be attempted live in a chat session with an LLM. Open the scenario, paste the prompt into your model of choice (use Ctrl+Shift+V to paste so the model doesn't use the file as context), and iterate.
